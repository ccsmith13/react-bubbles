...
A token is used to authorize individual requests made by users as they are passed to the application.

- [X] What steps can you take in your web apps to keep your data secure?

Require complex password / login validation or two-step authentication. Encrypt data. Secure OTPs for forgotten password retrieval. Try to hack your app yourself as part of security testing.

- [X] Describe how web servers work.

Browser connects to a server and requests a page, then the server sends back the page you have requestes (very basic explanation). 

- [X] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

Create = PUT with new data / POST, Read = GET, Update = PUT to existng data, Delete = DELETE 
